...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 14, 2020 at 11:15 AM
...
CREATE TABLE `tb_mata_anggaran` (
  `kode_rekening` bigint(25) NOT NULL,
  `nama_rekening` text,
...
(1, 'administrator', 'Administrator', 4, '$2y$10$3UdycJoCQ1ne7XjjyPx/t.OfW9oqDrEenln3p/sl7gxTSfN9G5rry');
